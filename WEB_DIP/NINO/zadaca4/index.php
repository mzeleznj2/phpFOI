...
<html>
    ...
    <section id="sadrzaj">
        <p class="naslov" >Web dizajn i programiranje</p>
        <section>
            
            <p class="podnaslov">O kolegiju:</p>
            <p>
        ...
        <hr style="color: #f0000f; width: 95%"/> 
        <section>
           <p class="podnaslov">Ishodi učenja:</p> 
           <p>
            - analizirati opterećenje Web poslužitelja i predložiti potrebne radnje za poboljšanje njegovih performansi<br/>
            - izraditi Web aplikacije različite namjene i složenosti ...<br/>
            - razlikovati Web tehnologije<br/>
            - razumijeti osobine skriptnih programskih jezika i koristiti ih u realizaciji Web aplikacije<br/>
            - razumjeti i koristiti razne servise za potrebe Web aplikacija<br/>
            - razumjeti i primijeniti hipertekstualno i hipermedijsko povezivanje dokumenata<br/>
            - razumjeti i primijeniti preporuke Web dizajna<br/>
            - razumjeti i primijeniti preporuke Web inženjerstva<br/>
            - razumjeti način funkcioniranja Web mjesta i Web aplikacija<br/>
            - razumjeti osobine korisničke i poslužiteljske strane Web aplikacija te ih primijeniti na način koji odgovara specifičnostima pojedinog projekta<br/>
            - razumjeti principe rada Web autorskih alata i znati ih koristiti ih u razvoju Web mjesto<br/>
           </p>
        </section>
        <hr style="color: #f0000f; width: 95% "/>
        <section>
            <p class="podnaslov" id="sadrzaj_predavanja">Sadržaj predavanja:</p>
            <article>
                Internet, Web, protokoli, HTTP protokol<br/>
            ...
            <article>
                HTML jezik – uvod, DTD, XML, XHTML, osnovne oznake<br/>
            ...
            <article>
                HTML jezik – tablice, okviri, obrasci<br/>
            ...
            <article>
                Kaskadni oblik formatiranja dokumenta (CSS)<br/>
            ...
            <article>
                Dizajn Web mjesta, autorski alati<br/>
            ...
            <article>
                Uvod u programiranje na strani poslužitelja<br/>
            ...
            <article>
                PHP jezik – uvod i sintaksa, funkcije, korištenje datoteka, obrada pogrešaka i postavljenje razine izvještavanja<br/>
            ...
            <article>
                PHP jezik – rad s bazom podataka, korištenje imeničkih servisa, slanje email poruke<br/>
            ...
            <article>
                PHP jezik – autentikacija, autorizacija i dnevnik rada<br/>
            ...
            <article>
                PHP jezik – Smarty predlošci, XML, XSL, XSTL, SAX, DOM, generiranje digitalnih slika i pdf dokumenata<br/>
            ...
            <article>
                Javascript – uvod i sintaksa jezika, osnovi objekti<br/>
            ...
            <article>
                Javascript – ugrađeni objekti, upravljanje događajima<br/>
            ...
            <article>
                Javascript – objektni model dokumenta - DOM<br/>
            ...
            <article>
                Javascript – dozvoljeni izrazi, AJAX, novi trendovi u Web tehnologijama<br/>
            ...
            <article>
                Razvoj Web mjesta, mjerenje opterećenje Web poslužitelja, Web inženjerstvo<br/>
    ...
    <footer id="footer">
        <a href="http://validator.w3.org/check?uri=http://arka.foi.hr/WebDiP/2013/zadaca_03/nzvorc/"><img src="img/html-5.png" height="100" alt="valid_html" /></a>
        <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://arka.foi.hr/WebDiP/2013/zadaca_03/nzvorc"><img src="img/css.png" height="100" alt="valid_css" /></a>
        <br />
        Vrijeme potrebno za riješavanje <b>aktivnog dokumenta / zadaće: 1h / 20h</b>
       <br/>
    </footer>
    </body>
</html>
