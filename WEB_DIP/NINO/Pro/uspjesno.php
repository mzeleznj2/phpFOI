<?php
    ...
    $poruka=$imeprezime.", ";
        ...
        $e = $_GET["e"];
        switch ($e) {
            case 1: $poruka .= "uspješno ste kupili kartu.";
                break;
            case 2: $poruka .= "uspješno ste platili kaznu.";
                break;
            case 3: $poruka = "Korisnik je uspješno aktiviran";
                break;
            case 4: $poruka = "Korisniku je uspješno izdana kazna";
                break;
        ...
        <section id="sadrzaj">
            <article>
                ...
                <h5 style="text-align: center;">
                    <img src="img/kvacica.png" alt="stop" style=""/>
                    <br>
